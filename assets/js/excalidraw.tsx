...
export default function App() {
  ...
  React.useEffect(() => {
    ...
    const binding = new ExcalidrawBinding(ydoc.getArray('elements'), api, provider.awareness)
    setBindings(binding)
    const assetBinding = new ExcalidrawAssetsBinding(ydoc.getMap('assets'), api)
    return () => {
      setBindings(null)
      binding.destroy()
  ...
  return <div style={{ height: "100vh" }}>
    <Excalidraw excalidrawAPI={setApi} onPointerUpdate={binding?.onPointerUpdate} theme="light" />
  </div>
}
